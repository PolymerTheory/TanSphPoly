...
enum { nf = 12}; // number of flexible chains
enum { ns = 12}; // number of stiff chains
enum { Nf = 40}; // number of beads in flexible chains
enum { Ns = 40}; // number of beads in stiff chains
...
// numbers of MC steps
enum { nrelax_pb = 80000}; // relaxation steps per bead
enum { neval_pb  = 80000}; // evaluation steps per bead
enum { nskip_pb = 8000}; // number of steps per bead between outputs
